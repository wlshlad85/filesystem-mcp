    ...
    return {
        tools: [
            ...
            // Playwright tools
            {
                ...
                description: "Launch a new browser instance using Playwright. This creates a browser context and page " +
                ...
                inputSchema: zodToJsonSchema(PlaywrightLaunchArgsSchema),
            },
            {
                name: "playwright_close",
                description: "Close the current browser instance and clean up all resources. " +
            ...
            },
            {
                ...
                description: "Navigate the browser to a specified URL. Waits for the page to load according to the " +
                    "specified criteria (load, domcontentloaded, or networkidle). " +
                    "Requires an active browser instance from playwright_launch.",
                inputSchema: zodToJsonSchema(PlaywrightNavigateArgsSchema),
            },
            {
                name: "playwright_screenshot",
                description: "Take a screenshot of the current page. Can capture the visible viewport or the full page. " +
                ...
                inputSchema: zodToJsonSchema(PlaywrightScreenshotArgsSchema),
            },
            {
                name: "playwright_click",
                description: "Click on an element matching the provided CSS selector. " +
                    "Waits for the element to be visible and clickable before performing the action. " +
                    "Requires an active browser instance.",
                inputSchema: zodToJsonSchema(PlaywrightClickArgsSchema),
            },
            {
                name: "playwright_fill",
                description: "Fill an input field with the specified text. Clears any existing value before filling. " +
                    "The element must be an input, textarea, or contenteditable element. " +
                    "Requires an active browser instance.",
                inputSchema: zodToJsonSchema(PlaywrightFillArgsSchema),
            },
            {
                ...
                description: "Execute JavaScript code in the context of the current page. " +
                    ...
                    "Requires an active browser instance.",
                inputSchema: zodToJsonSchema(PlaywrightEvaluateArgsSchema),
            },
            {
                ...
                description: "Wait for an element matching the CSS selector to reach the specified state. " +
                    ...
                    "Requires an active browser instance.",
                inputSchema: zodToJsonSchema(PlaywrightWaitForSelectorArgsSchema),
            },
            {
                name: "playwright_get_text",
                description: "Get the text content of an element matching the provided CSS selector. " +
                    "Waits for the element to be visible before retrieving text. " +
                    "Requires an active browser instance.",
                inputSchema: zodToJsonSchema(PlaywrightGetTextArgsSchema),
            },
        ],
    };
});
